 ...
 */
    ...
    $products->setProductList(isset($_GET['category']) ? $_GET['category'] : "", isset($_GET['keyword']) ? $_GET['keyword'] : "");
        ...
        <div class="bg-content">
            <div class="container references-container">   
                <div class="product-section">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 references-page-img-container" style="height: 500px;">
